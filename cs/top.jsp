	...
	<header>
		<div class="wrapper">
			<span class="logoimg"> <a href="/AcornSHOP/index.jsp"> <img
					id="logoimg" src="images/logo1.gif" width="200" height="130"></a>
			</span>
			<nav class="top-bar__menu-box">
				<ul class="menu">
					<li><a class="jo" href="/AcornSHOP/about/about.jsp">About</a>
						<ul>
					...
					<li class="jo"><jsp:include page="login/login.jsp"
							flush="false" />
					<li class="cartimg"><a href="../mypage/cart.jsp"><img id="cartimg"
							src="images/cart.png" width="50" height="50"></a>
				</ul>
			</nav>
		</div>
	</header>
