...
%>
	<div id="message">
		...
		<span><a href="/AcornSHOP/login/join.jsp" class="jo" >Sign</a></span>	
		</form>
	</div>	
...
<%
	...
	<span class='logintext'><%=id%> 관리자 ▶&nbsp;</span>
  	<span><a href="/AcornSHOP/admin/admin.jsp" class='jo'>관리자페이지</a></span>
  	<span class='logintext'>&nbsp; / &nbsp;</span>
  	<span><a href='/AcornSHOP/login/logout.jsp'' class='jo' >Logout</a></span>
	<%
 	 }else if(id!="TEST"){ 
	%>
  	...
  	<span class='logintext'>&nbsp; / &nbsp;</span>
  	<span><a href="/AcornSHOP/mypage/mypage.jsp" class='jo' onClick=''>Mypage</a></span>
  	<%
		}
	%>
  	<span class='logintext'>&nbsp; / &nbsp;</span>
